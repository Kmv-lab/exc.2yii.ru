    ...
    <div class="gallery-form">
        ...
        if(!$model->getIsNewRecord()){
            ...
            foreach ($photos AS $key=>$photo){
                $id = $photo->id_photo;
                $i++;
                $delUrl = URL::to(['delete_photo', 'id'=>$id, 'id_res'=>$_GET['id'], 'name'=>$_GET['name']]);
                ...
                <div class="form-group image_thumb">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3" style="float: right;padding-top: 20px;">
                            ...
                            <div class="form-group">
                                <a href="#" class="btn btn-primary btn-xs show-dialog-thumb" data-id="<?=$id?>" data-file_name="<?=$photo->file_name?>" >
                                    Редактировать миниатюру <?=$iconEdit?>
                                </a>
                            </div>
                            <div class="form-group">
                                <a href="<?=$resetUrl?>" class="btn btn-primary btn-default btn-xs reset-thumb">
                                    Сбросить миниатюры <?=$iconEdit?>
                                </a>
                            </div>
                            <div class="form-group">
...
<div id="dialog-thumb"  title="Редактирование миниатюры" data-big="<?=\app\modules\adm\models\GPhotoSanatoriums::DIRview().'original/'?>"
