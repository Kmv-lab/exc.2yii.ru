                ...
                <div class="form-group image_thumb">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3" style="float: right;padding-top: 20px;">
                            <div class="form-group">
                                <select style="display: none" class="is_main_sanatorium_photo form-control input-sm" name="Photo_ratio_1" id="Photo_ratio_1">
                            ...
                            <div class="form-group">
                                <a href="#" class="btn btn-primary btn-xs show-dialog-thumb" data-id="1" data-file_name="<?=$model['main_photo']?>" >
