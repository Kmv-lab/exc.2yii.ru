...
<div class="actions-update">
    <div class="actions-form">
        ...
        <?= $form->field($model, 'priority',[
            'template' => '{label} <div class="col-sm-3">{input}{error}{hint}</div>',
...
<div id="dialog-thumb"  title="Редактирование миниатюры" data-big="<?=\app\modules\adm\models\Actions::DIRview().'original/'?>"
     data-url="<?=URL::to(['ajaxcreatethumb'])?>" class="modal fade">
